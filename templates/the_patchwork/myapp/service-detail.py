	...
	<section class="services-detail">
		<div class="auto-container">
			...
			<div class="service-detail_image">
				<img src="{{% static 'the_patchwork/images/resource/service-detail.jpg' %}}" alt="" />
			</div>
		</div>
	</section>
	<!-- End Services One -->
		...
		<div class="auto-container">
			<div class="inner-container">
				...
				<div class="sec-title">
					...
					<h2 class="sec-title_heading">The PatchWork™ <span>typically operate</span> in <br> a three steps</h2>
				</div>
						...
						<div class="step-block_one">
							<div class="step-block_one-inner">
								...
								<div class="step-block_one-content">
									<div class="image">
										<img src="{{% static 'the_patchwork/images/resource/step-1.png' %}}" alt="" />
									</div>
								</div>
							</div>
						</div>
					...
					<div class="column col-lg-6 col-md-12 col-sm-12">
						...
						<div class="step-block_one">
							<div class="step-block_one-inner">
								...
								<div class="step-block_one-content">
									<div class="image">
										<img src="{{% static 'the_patchwork/images/resource/step-2.png' %}}" alt="" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="step-block_one">
							<div class="step-block_one-inner">
								...
								<div class="step-block_one-content">
									<div class="image">
										<img src="{{% static 'the_patchwork/images/resource/step-3.png' %}}" alt="" />
									</div>
								</div>
							</div>
						</div>
			...
			<div class="sec-title style-four">
				<div class="d-flex justify-content-between align-items-center flex-wrap">
					<div class="left-box">
						...
						<h2 class="sec-title_heading">Unveiling <span>solutions</span> for common dilemmas in The PatchWork™</h2>
					</div>
					<div class="right-box">
						<p>Lorem ipsum dolor sit amet consectetur adipiscing elit Ut et massa  Aliquam in hendrerit urna. Pellentesque sit amet sapien fringilla, mattis l consectetur, ultrices mauris. Maecenas vitae mattis tellus. Nullam quis imperdiet augue. Vestibulum auctor ornare leo, non suscipit magna</p>
			...
			<div class="row clearfix">
				<div class="column col-lg-6 col-md-6 col-sm-12">
					<div class="service-detail_image-two">
						<img src="{{% static 'the_patchwork/images/resource/service-detail-1.jpg' %}}" alt="" />
					</div>
				</div>
				<div class="column col-lg-6 col-md-6 col-sm-12">
					<div class="service-detail_image-two">
						...
						<img src="{{% static 'the_patchwork/images/resource/service-detail-2' %}}" alt="" />
					</div>
				</div>
			</div>
